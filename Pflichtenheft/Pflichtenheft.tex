...
\item Die Standortverfolgung wird im Fall von weniger 5 losgegangen Benutzern nicht ausgeführt.
...
%\begin{figure}[H]
%	\centering
%	\includegraphics[width=.7\textwidth]{GUI/AndroidStudio/login_compl.png}
%	\caption{Die eigentliche Login-Seite von Firebase}	
%\end{figure}
\begin{figure}[H]
	\centering
