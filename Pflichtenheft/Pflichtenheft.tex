...
%keie Kontakte, sondern Leute direkt über den Benutzernamen in eine Gruppe hinzufügen
	...
	Ein Benutzer kann sich alle Gruppen, in denen er zu diesem Zeitpunkt Mitglied ist, anzeigen lassen, indem er den 'Gruppen'-Reiter der Hauptansicht auswählt (vgl. *GUI-Ansicht*)
	...
	\begin{itemize}
		...
		\item aktuelle GO's der Gruppe %kann geklickt werden, um in die Ansicht des jeweiligen GOs zu gelangen --> Querverweis einfügen
	\end{itemize}
	...
	Ein Benutzer, der Mitglied einer Gruppe ist, kann aus derselben austreten. Sollte der Benutzer einziger Administrator der Gruppe sein, muss zuerst ein weiteres aktuelles Mitglied der Gruppe zum Administrator ernannt werden (siehe Funktion \ref{Admin hinzufügen}, bevor diese Funktion ausgeführt werden kann. \\
