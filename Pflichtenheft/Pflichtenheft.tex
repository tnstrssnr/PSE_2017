...
\newglossaryentry{Android-Benachrichtigung}
{
	...
	description={Benachrichtigungen, die dem Benutzer auf dem Smartphone-Bildschirm angezeigt werden, sobald etwas Neues in der App passiert ist. Dies erfordert nicht das Öffnen der App},
...
\newglossaryentry{GO-Verantwortlicher}
{
	...
	description={Der Ersteller eines GOs wird immer zum GO-Verantwortlichen desselben. Er ist verantwortlich für die Administration des GOs (Daten ggfs. ändern, GO vorzeitig beenden, etc.). Ihm stehen mehr Funktionen zur Verfügung wie normalen GO-Teilnehmern},
}
\newglossaryentry{Administrator}
{
	name={Administrator},
	description={Der Administrator ist für die Verwaltung einer Gruppe zuständig. Dazu gehört beispielsweise das Hinzufügen und Entfernen von Gruppenmitgliedern oder das Einpflegen von Gruppendaten. Jede Gruppe muss stets mindestens einen Administrator haben. Es ist zulässig, dass eine Gruppe mehr als einen Administrator hat}
}
...
% Funktionalität, Zuverlässigkeit, Benutzbarkeit, Effizienz, Veränderbarkeit, Übertragbarkeit
