...
%keie Kontakte, sondern Leute direkt über den Benutzernamen in eine Gruppe hinzufügen
	...
	\begin{itemize}
		...
		\item aktuelle GO's der Gruppe %kann geklickt werden, um in die Ansicht des jeweiligen GOs du gelangen --> Querverweis einfügen
	\end{itemize}
	...
	\end{itemize}
In beiden Fällen wird der Sender der Anfrage über die Beantwortung informiert (vgl. \ref{Mitglieder hinzufügen}) und anschließend die Anfrage vom System gelöscht.
