...
public class GoAddedObserverTest {
    ...
    private static final EventArg EXPECTED_EVENT = EventArg.GO_ADDED_EVENT;

    //might change after testing goEntityToGo method
    private static final String EXPECTED_JSON = "{\"goId\":1,\"name\":\"lunch\",\"description\":\"test description\",\"start\":\"Thu Aug 30 00:00:00 CEST 3917\",\"end\":\"Sat Sep 01 00:00:00 CEST 3917\",\"group\":{\"groupId\":0,\"name\":\"Foo\",\"description\":\"Test Descritpion\",\"memberCount\":0,\"membershipList\":[],\"currentGos\":[]},\"lat\":0.0,\"lon\":0.0,\"userId\":\"testid_1\",\"ownerName\":\"Bob\",\"participantsList\":[{\"user\":{\"userId\":\"testid_1\",\"instanceId\":\"testInstance_1\",\"name\":\"Bob\",\"email\":\"bob@testmail.com\"},\"status\":\"GOING\"}],\"locations\":[]}";
    ...
    public void setUp() throws Exception {
        ...
        observer = new GoAddedObserver(mockMessenger, mockService);
    }
    ...
    public void constructorTest1() {
        observer = new GoAddedObserver(mockService);
