...
/**
 * Created by tina on 26.08.17.
 */
public class RequestDeniedObserverTest {

    private static final String TEST_RECEIVER = "receiver_instance_id";
    private static final EventArg EXPECTED_EVENT = EventArg.GROUP_REQUEST_DENIED_EVENT;
    ...
    private RequestDeniedObserver observer;
    ...
    public void setUp() throws Exception {
        ...
        observer = new RequestDeniedObserver(mockMessenger, mockService);
    }
    ...
    public void constructorTest1() {
        observer = new RequestDeniedObserver(mockService);
