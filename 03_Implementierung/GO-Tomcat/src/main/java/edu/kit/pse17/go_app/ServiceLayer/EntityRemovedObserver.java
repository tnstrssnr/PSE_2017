...
public class EntityRemovedObserver implements Observer {
     ...
     * wird bei der Erzeugun eines OBserver Objekts automatisch instanziiert (durch Benutzung des einzigen,
     * argumentlosen Konstruktors der FcmClient-Klasse). Danach kann das von außen Attribut nicht mehr verändert
     * werden.
     */
    ...
    /**
     * Implementierung der update()-Methode. Wird überladen, um die unterschiedlichen Ereignisse, auf die dieser
     * Observer reagieren kann zu unterscheiden.
     *
     ...
     * @param o          Ein Objekt, das die Änderungen, um die der Beobachter sich kümmern muss enthält. Da es sich um
     *                   den Datentyp "Object" handelt, ist der Beobachter sehr flexibel, welche Änderungen ihm
     *                   übergeben werden können. Dies erleichert auch das Überladen der Methode, wodurch ein Beobachter
     *                   mehrere
     */
    @Override
    public void update(final String arg, final Observable observable, final Object o) {
