...
public enum Status {
     ...
     * Ersteller selbst. Der Ersteller kann niemals den Status "ABGELEHNT" annehmen.
     */
    NOT_GOING,

    /**
     * bedeutet, dass der Benutzer an dem GO teilnehmen wird. Er ist in dem GO aller dings noch nicht aktiv, d.h. er
     * teilt seinen Standort nicht mit anderen. Gibt es andere Teilnehmer in dem GO, die bereits "UNTERWEGS" sind, kann
     ...
     * anderen GO-Teilnehmern. Dieser kann von Benutzern mit dem Status "UNTERWEGS" oder "BESTÄTIGT" angesehen werden.
     */
    GONE
}
