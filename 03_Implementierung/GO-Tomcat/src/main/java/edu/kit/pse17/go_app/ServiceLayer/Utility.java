...
public class Utility {
    ...
    public static Vector<UserLocation> VisitList = new Vector<>();
    ...
    public static Vector<UserLocation> getList(List<UserLocation> userLocationList) {
        ...
        Vector<UserLocation> newList = new Vector<>();
        newList.clear();
    ...
    /**
     * Eine Methode, die vergleicht ob zwei Punkte/UserLocations "identisch" sind, beziehungsweise die gleichen
     * Koordinaten haben.
     *
