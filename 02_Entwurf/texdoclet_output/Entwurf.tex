...
\hspace{1.0cm} $\bullet$ edu.kit.pse17.go\_app.ServerCom.JSON.LocationParser {\tiny \refdefined{edu.kit.pse17.go_app.ServerCom.JSON.LocationParser}} \\
...
\hyperlink{edu.kit.pse17.go_app.View.GroupListActivity.start(Activity)}{{\bf start(Activity)}} \\
\end{verse}
}
\subsubsection{Constructors}{
\vskip -2em
...
\hypertarget{edu.kit.pse17.go_app.View.GroupListActivity.start(Activity)}{{\bf  start}\\}
\begin{lstlisting}[frame=none]
...
\entityintro{LocationParser}{edu.kit.pse17.go_app.ServerCom.JSON.LocationParser}{Created by tina on 20.06.17.}
...
\end{lstlisting}
\subsubsection{All known subinterfaces}{GroupParser\small{\refdefined{edu.kit.pse17.go_app.ServerCom.JSON.GroupParser}}, LocationParser\small{\refdefined{edu.kit.pse17.go_app.ServerCom.JSON.LocationParser}}, UserParser\small{\refdefined{edu.kit.pse17.go_app.ServerCom.JSON.UserParser}}, GoParser\small{\refdefined{edu.kit.pse17.go_app.ServerCom.JSON.GoParser}}}
\subsubsection{All classes known to implement interface}{GroupParser\small{\refdefined{edu.kit.pse17.go_app.ServerCom.JSON.GroupParser}}, LocationParser\small{\refdefined{edu.kit.pse17.go_app.ServerCom.JSON.LocationParser}}, UserParser\small{\refdefined{edu.kit.pse17.go_app.ServerCom.JSON.UserParser}}, GoParser\small{\refdefined{edu.kit.pse17.go_app.ServerCom.JSON.GoParser}}}
\subsubsection{Method summary}{
\begin{verse}
...
\hyperlink{edu.kit.pse17.go_app.ServerCom.JSON.GoParser.parseToJson(edu.kit.pse17.go_app.Model.GO)}{{\bf parseToJson(GO)}} \\
\end{verse}
}
\subsubsection{Constructors}{
\vskip -2em
...
\hypertarget{edu.kit.pse17.go_app.ServerCom.JSON.GoParser.parseToJson(edu.kit.pse17.go_app.Model.GO)}{{\bf  parseToJson}\\}
\begin{lstlisting}[frame=none]
public JSONObject parseToJson(edu.kit.pse17.go_app.Model.GO go)\end{lstlisting} %end signature
}%end item
\end{itemize}
}
}
...
\hyperlink{edu.kit.pse17.go_app.ServerCom.JSON.GroupParser.parseToJson(edu.kit.pse17.go_app.Model.Group)}{{\bf parseToJson(Group)}} \\
\end{verse}
}
\subsubsection{Constructors}{
\vskip -2em
...
\hypertarget{edu.kit.pse17.go_app.ServerCom.JSON.GroupParser.parseToJson(edu.kit.pse17.go_app.Model.Group)}{{\bf  parseToJson}\\}
\begin{lstlisting}[frame=none]
public JSONObject parseToJson(edu.kit.pse17.go_app.Model.Group group)\end{lstlisting} %end signature
}%end item
\end{itemize}
}
}
\subsection{\label{edu.kit.pse17.go_app.ServerCom.JSON.LocationParser}Class LocationParser}{
\hypertarget{edu.kit.pse17.go_app.ServerCom.JSON.LocationParser}{}\vskip .1in 
Created by tina on 20.06.17.\vskip .1in 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\subsubsection{Constructor summary}{
\begin{verse}
\hyperlink{edu.kit.pse17.go_app.ServerCom.JSON.LocationParser()}{{\bf LocationParser()}} \\
\end{verse}
}
\subsubsection{Method summary}{
\begin{verse}
\hyperlink{edu.kit.pse17.go_app.ServerCom.JSON.LocationParser.parseFromJson(JSONObject)}{{\bf parseFromJson(JSONObject)}} \\
\hyperlink{edu.kit.pse17.go_app.ServerCom.JSON.LocationParser.parseToJson(edu.kit.pse17.go_app.Model.GroupLocation)}{{\bf parseToJson(GroupLocation)}} \\
\end{verse}
}
\subsubsection{Constructors}{
\vskip -2em
...
\hypertarget{edu.kit.pse17.go_app.ServerCom.JSON.LocationParser()}{{\bf  LocationParser}\\}
\begin{lstlisting}[frame=none]
public LocationParser()\end{lstlisting} %end signature
}%end item
\end{itemize}
}
\subsubsection{Methods}{
...
\item{ 
\index{parseFromJson(JSONObject)}
\hypertarget{edu.kit.pse17.go_app.ServerCom.JSON.LocationParser.parseFromJson(JSONObject)}{{\bf  parseFromJson}\\}
\begin{lstlisting}[frame=none]
java.lang.Object parseFromJson(JSONObject o)\end{lstlisting} %end signature
\begin{itemize}
\item{
...
\item{ 
\index{parseToJson(GroupLocation)}
\hypertarget{edu.kit.pse17.go_app.ServerCom.JSON.LocationParser.parseToJson(edu.kit.pse17.go_app.Model.GroupLocation)}{{\bf  parseToJson}\\}
\begin{lstlisting}[frame=none]
public JSONObject parseToJson(edu.kit.pse17.go_app.Model.GroupLocation groupLocation)\end{lstlisting} %end signature
}%end item
\end{itemize}
}
}
...
\hyperlink{edu.kit.pse17.go_app.ServerCom.JSON.UserParser.parseToJson(edu.kit.pse17.go_app.Model.User)}{{\bf parseToJson(User)}} \\
\end{verse}
}
\subsubsection{Constructors}{
\vskip -2em
...
\hypertarget{edu.kit.pse17.go_app.ServerCom.JSON.UserParser.parseToJson(edu.kit.pse17.go_app.Model.User)}{{\bf  parseToJson}\\}
\begin{lstlisting}[frame=none]
public JSONObject parseToJson(edu.kit.pse17.go_app.Model.User user)\end{lstlisting} %end signature
}%end item
\end{itemize}
}
}
