...
\hspace{1.0cm} $\bullet$ edu.kit.pse17.go\_app.ServerCom.HttpRequestHandler {\tiny \refdefined{edu.kit.pse17.go_app.ServerCom.HttpRequestHandler}} \\
...
\hyperlink{edu.kit.pse17.go_app.View.GroupListActivity.start(Activity, java.lang.String)}{{\bf start(Activity, String)}} \\
\end{verse}
}
\subsubsection{Constructors}{
\vskip -2em
...
\item{ 
\index{start(Activity, String)}
\hypertarget{edu.kit.pse17.go_app.View.GroupListActivity.start(Activity, java.lang.String)}{{\bf  start}\\}
\begin{lstlisting}[frame=none]
public static void start(Activity activity,java.lang.String uid)\end{lstlisting} %end signature
}%end item
\end{itemize}
}
}
...
\vskip .13in
\hbox{{\bf  Classes}}
\entityintro{HttpRequestHandler}{edu.kit.pse17.go_app.ServerCom.HttpRequestHandler}{Adapter-Klasse, die von anderen Klassen benutzt werden kann, um HTTP-Anfragen an den tomcat-Server zu schicken Created by tina on 19.06.17.}
\vskip .1in
\vskip .1in
\subsection{\label{edu.kit.pse17.go_app.ServerCom.HttpRequestHandler}Class HttpRequestHandler}{
\hypertarget{edu.kit.pse17.go_app.ServerCom.HttpRequestHandler}{}\vskip .1in 
...
\subsubsection{Constructor summary}{
\begin{verse}
\hyperlink{edu.kit.pse17.go_app.ServerCom.HttpRequestHandler()}{{\bf HttpRequestHandler()}} \\
\end{verse}
}
\subsubsection{Method summary}{
\begin{verse}
\hyperlink{edu.kit.pse17.go_app.ServerCom.HttpRequestHandler.sendReadRequest()}{{\bf sendReadRequest()}} sendet POSTRequest an Tomcat\\
\hyperlink{edu.kit.pse17.go_app.ServerCom.HttpRequestHandler.sendWriteRequest()}{{\bf sendWriteRequest()}} \\
\end{verse}
}
\subsubsection{Constructors}{
\vskip -2em
\begin{itemize}
\item{ 
\index{HttpRequestHandler()}
\hypertarget{edu.kit.pse17.go_app.ServerCom.HttpRequestHandler()}{{\bf  HttpRequestHandler}\\}
\begin{lstlisting}[frame=none]
public HttpRequestHandler()\end{lstlisting} %end signature
}%end item
\end{itemize}
}
\subsubsection{Methods}{
...
\begin{itemize}
\item{ 
\index{sendReadRequest()}
\hypertarget{edu.kit.pse17.go_app.ServerCom.HttpRequestHandler.sendReadRequest()}{{\bf  sendReadRequest}\\}
\begin{lstlisting}[frame=none]
protected java.lang.Object sendReadRequest()\end{lstlisting} %end signature
\begin{itemize}
\item{
{\bf  Description}
...
\item{ 
\index{sendWriteRequest()}
\hypertarget{edu.kit.pse17.go_app.ServerCom.HttpRequestHandler.sendWriteRequest()}{{\bf  sendWriteRequest}\\}
\begin{lstlisting}[frame=none]
public void sendWriteRequest()\end{lstlisting} %end signature
}%end item
\end{itemize}
}
}
