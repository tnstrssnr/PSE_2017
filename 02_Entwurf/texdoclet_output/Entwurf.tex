...
\entityintro{GoRepository}{edu.kit.pse17.go_app.model.GoRepository}{Das Go-Repository ist verantwortlich für sämtliche Operationen auf den Go-Daten und stellt eine einfache Schnittstelle zum Holen, Ändern und Löschen von Daten zur Verfügung.}
...
\entityintro{GroupRepository}{edu.kit.pse17.go_app.model.GroupRepository}{Das Go-Repository ist verantwortlich für sämtliche Operationen auf den Go-Daten und stellt eine einfache Schnittstelle zum Holen, Ändern und Löschen von Daten zur Verfügung.}
